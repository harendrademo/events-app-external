...
//        e.g https://github.com/harendrademo/events-app-external.git might become https://github.com/MyName/external.git
// variables:
//      roidtc-july2022-user219
...
//      https://github.com/harendrademo/events-app-external.git
//      harendrademo
//      del-external
//      cluster-1
...
pipeline {
   ...
   environment {
        ...
        imageName = 'harendrademo/del-external'
        dockerImage = ''
        }
    stages {
        stage('Run the tests') {
